$(function(){
    ...
    $('#tournament_5on5__btn').on('click', function () {
        $('[data-remodal-id=tournament_5on5]').remodal().open();
    });
    $('#schejule_5on5__btn').on('click', function () {
        $('[data-remodal-id=schejule_5on5]').remodal().open();
    });
