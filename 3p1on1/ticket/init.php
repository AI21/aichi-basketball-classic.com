...
//受け取る時の件名
define('MAILSUBJECT','[愛知最強1on1＆3Pコンテスト決定戦] 観戦チケットの申し込みがあります。');

//自動返信の件名
define('REPSUBJECT','[愛知最強1on1＆3Pコンテスト決定戦] 観戦チケットの申し込み 内容控え');
...
愛知最強1on1＆3Pコンテスト決定戦への観戦チケットの申し込み、ありがとうございました。

受付しました内容を確認後、下記の詳細を大会事務局より返信させていただきます。

・チケット代金の支払い方法について
・チケットの受け取り方法について

※ 1〜2日経過してもメールがない場合は、大会事務局の公式メールアドレスにご一報ください。
※ ご記入いただいた内容によっては、大会事務局から確認の連絡をさせていただきます。
