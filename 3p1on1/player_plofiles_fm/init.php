...
//受け取る時の件名
define('MAILSUBJECT','[愛知最強1on1＆3P] プレイヤープロフィール申請');

//自動返信の件名
define('REPSUBJECT','[愛知最強1on1＆3Pコンテスト予選大会] プレイヤープロフィール申請 内容控え');
...
愛知最強1on1＆3Pコンテスト予選大会へのエントリーありがとうございました。

参加への詳しい内容については大会事務局より追って連絡させていただきますので、しばらくお待ちください。
※2〜3日経過してもメールがない場合は大会事務局の公式メールアドレスにご一報ください。
