...
//差出人名
define('FROMNAME',"愛知最強決定戦 ABC事務局");

//受け取る時の件名
define('MAILSUBJECT','[愛知最強1on1＆3Pコンテスト予選大会] 選手エントリー');

//自動返信の件名
define('REPSUBJECT','[愛知最強1on1＆3Pコンテスト予選大会] 選手エントリー 内容控え');
...
愛知最強1on1＆3Pコンテスト予選大会へのエントリー専用フォームをお知らせします。

■1on1・3Pコンテスト 一般予選エントリーフォーム
http://www.aichi-basketball-classic.com/3p1on1/entry_mains/

＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
◎このメールは、2016年6月5日に行われる愛知最強1on1＆3Pコンテスト予選大会へのエントリーを希望された方へお送りしています。
◎このメールの内容に覚えの無い方は、下記よりお問い合わせ下さい。
⇒ aichi3on3.info@gmail.com
クリックできない時はURLをブラウザのアドレスバーへ貼り付けて下さい。
