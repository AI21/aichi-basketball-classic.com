...
//受け取る時の件名
define('MAILSUBJECT','[考えるバスケットの会クリニック] 参加エントリー');

//自動返信の件名
define('REPSUBJECT','[考えるバスケットの会クリニック] 参加エントリー 内容控え');
...
考えるバスケットの会クリニックへの参加エントリーありがとうございました。

参加への詳しい内容については「中川直之 考えるバスケットの会クリニック実行委員会」より
追って連絡させていただきますので、しばらくお待ちください。
※2〜3日経過してもメールがない場合は「中川直之 考えるバスケットの会クリニック実行委員会」の
公式メールアドレスにご一報ください。
